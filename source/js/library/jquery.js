...
!(function(e, t) {
	...
	(w.fn = w.prototype = {
		...
		var e,
			...
			l = !1;
		for (
			'boolean' == typeof a && ((l = a), (a = arguments[s] || {}), s++), 'object' == typeof a || g(a) || (a = {}), s ===
				u && ((a = this), s--);
			s < u;
			s++
		)
	...
	var E = (function(e) {
		...
		(n = oe.support = {}), (o = oe.isXML = function(e) {
			...
			pseudos: {
				...
				lang: se(function(e) {
					return U.test(e || '') ||
						oe.error('unsupported lang: ' + e), (e = e.replace(Z, ee).toLowerCase()), function(t) {
						var n;
						do {
		...
		return (s = oe.compile = function(e, t) {
			...
			b.split('').sort(D).join('') === b), (n.detectDuplicates = !!f), p(), (n.sortDetached = ue(function(e) {
		...
		queue: function(e, t, n) {
			...
			if (e)
				return (t = (t || 'fx') + 'queue'), (r = J.get(e, t)), n &&
					(!r || Array.isArray(n) ? (r = J.access(e, t, w.makeArray(n))) : r.push(n)), r || [];
		},
	...
	(w.event = {
		...
		add: function(e, t, n, r, i) {
			...
			if (y) {
				n.handler && ((n = (o = n).handler), (i = o.selector)), i && w.find.matchesSelector(be, i), n.guid ||
					(n.guid = w.guid++), (u = y.events) || (u = y.events = {}), (a = y.handle) ||
				...
				while (l--)
					(d = g = (s = Ce.exec(t[l]) || [])[1]), (h = (s[2] || '').split('.').sort()), d &&
						(
							(f = w.event.special[d] || {}),
			...
			if (y && (u = y.events)) {
				...
				while (l--)
					if (((s = Ce.exec(t[l]) || []), (d = g = s[1]), (h = (s[2] || '').split('.').sort()), d)) {
						(f = w.event.special[d] || {}), (p = u[(d = (r ? f.delegateType : f.bindType) || d)] || []), (s =
					...
					if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
						for (o = [], a = {}, n = 0; n < u; n++)
							void 0 === a[(i = (r = t[n]).selector + ' ')] &&
								(a[i] = r.needsContext ? w(i, this).index(l) > -1 : w.find(i, this, null, [l]).length), a[i] &&
								o.push(r);
		...
		e && e.type
			...
			: (this.type = e), t && w.extend(this, t), (this.timeStamp = (e && e.timeStamp) || Date.now()), (this[
			w.expando
		] = !0);
	}), (w.Event.prototype = {
		constructor: w.Event,
	...
	function Ze(e, t, n, r, i, o) {
		...
		return !r &&
			o >= 0 &&
			(u += Math.max(0, Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - o - u - s - 0.5))), u;
	}
	function et(e, t, n) {
		var r = $e(e),
			i = Fe(e, t, r),
	...
	w.extend({
		...
		css: function(e, t, n, r) {
			...
			return Xe.test(t) || (t = Je(s)), (a = w.cssHooks[t] || w.cssHooks[s]) &&
				'get' in a &&
				(i = a.get(e, !0, n)), void 0 === i && (i = Fe(e, t, r)), 'normal' === i && t in Ve && (i = Ve[t]), '' === n ||
			n
	...
	(w.Tween = tt), (tt.prototype = {
		...
		init: function(e, t, n, r, i, o) {
			(this.elem = e), (this.prop = n), (this.easing =
				i || w.easing._default), (this.options = t), (this.start = this.now = this.cur()), (this.end = r), (this.unit =
				o || (w.cssNumber[n] ? '' : 'px'));
		},
		cur: function() {
		...
		return w.fx.off
			...
			: 'number' != typeof r.duration &&
				(r.duration in w.fx.speeds
					...
					: (r.duration = w.fx.speeds._default)), (null != r.queue && !0 !== r.queue) || (r.queue = 'fx'), (r.old =
	...
	w.fn.extend({
		...
		prop: function(e, t, n) {
			var r,
				...
				o = e.nodeType;
			if (3 !== o && 8 !== o && 2 !== o)
				return (1 === o && w.isXMLDoc(e)) || ((t = w.propFix[t] || t), (i = w.propHooks[t])), void 0 !== n
			...
			if (
				...
				while ((s = v[a++]) && !t.isPropagationStopped())
					(h = s), (t.type = a > 1 ? l : d.bindType || m), (p =
						(J.get(s, 'events') || {})[t.type] && J.get(s, 'handle')) && p.apply(s, n), (p = c && s[c]) &&
						p.apply &&
						Y(s) &&
	...
	w.extend({
		...
		ajax: function(t, n) {
			...
			(f = w.event && h.global) &&
				0 == w.active++ &&
				w.event.trigger('ajaxStart'), (h.type = h.type.toUpperCase()), (h.hasContent = !Mt.test(
				h.type
	...
	w.ajaxSetup({
		...
		if (s || 'jsonp' === t.dataTypes[0])
			return (i = t.jsonpCallback = g(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback), s
				? (t[s] = t[s].replace(Qt, '$1' + i))
				: !1 !== t.jsonp && (t.url += (kt.test(t.url) ? '&' : '?') + t.jsonp + '=' + i), (t.converters[
				'script json'
			] = function() {
		...
		setOffset: function(e, t, n) {
			...
			'static' === c && (e.style.position = 'relative'), (s = f.offset()), (o = w.css(e, 'top')), (u = w.css(
				...
				: ((a = parseFloat(o) || 0), (i = parseFloat(u) || 0)), g(t) && (t = t.call(e, n, w.extend({}, s))), null !=
				t.top && (p.top = t.top - s.top + a), null != t.left && (p.left = t.left - s.left + i), 'using' in t
				? t.using.call(e, p)
				: f.css(p);
		},
	}), w.fn.extend({
